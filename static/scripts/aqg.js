...
class SuperUltraAtomicQuoteGenerator3000 extends React.Component {
  constructor(props) {
    ...
    // Make references to DOM elements and allow gsap animations
  ...
  componentDidUpdate() {
    // Trigger fadein and fadeout animations
  ...
  changeQuote() {
    // Set state to callback that will prevent loading of the same quote
