...
class App extends React.Component {
	...
	adjust_display(arr, new_person, stat) {
		...
		if (stat === true) {
			...
			this.setState((prevState, props) => ({ display: arr, seen: new Set(), current_score: 0, high_score: prevState.current_score > prevState.high_score ? prevState.current_score : prevState.high_score }))
		};
	};
